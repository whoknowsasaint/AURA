...
const sections = [
  {
    label: "Engineering",
    headline: "Every detail is a decision.",
  ...
  {
    label: "Materials",
    headline: "Built to outlast the decade.",
    ...
    <section className="bg-stone-50">
      {sections.map((s) => (
        ...
        >
          ...
          >
            <RevealOnScroll className="relative aspect-[4/3] bg-stone-100 overflow-hidden">
              <Image
                src={s.image}
                alt={s.headline}
                fill
            ...
            <RevealOnScroll delay={0.15} className="flex flex-col justify-center">
              ...
              <h2 className="text-[clamp(2rem,4vw,3.25rem)] font-light leading-[1.1] tracking-tight text-stone-900 mb-6 text-balance">
                {s.headline}
              </h2>
              ...
              <Link
                href={s.href}
                className="inline-flex items-center gap-2 text-[13px] tracking-wide text-stone-700 hover:text-stone-900 underline underline-offset-4 transition-colors duration-200 self-start"
              >
                {s.cta} &rarr;
              </Link>
            </RevealOnScroll>
